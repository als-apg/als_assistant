...
Examples:
    Process a single accelerator system::
        ...
        >>> from als_assistant.database.ao.process_matlab_data import main
...
from als_assistant.database.ao.ao_config import database_configs
...
from als_assistant.database.ao.data.manual_imports_LN import manual_imports_LN
from als_assistant.database.ao.data.manual_imports_LTB import manual_imports_LTB
from als_assistant.database.ao.data.manual_imports_BR import manual_imports_BR
from als_assistant.database.ao.data.manual_imports_BTS import manual_imports_BTS
from als_assistant.database.ao.data.manual_imports_SR import manual_imports_SR
