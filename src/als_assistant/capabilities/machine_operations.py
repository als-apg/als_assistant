...
from osprey.state.state_manager import get_execution_steps_summary
...
from osprey.utils.config import get_model_config, get_full_configuration
from osprey.utils.streaming import get_streamer
from als_assistant.context_classes import OperationResultsContext
from osprey.context.context_manager import ContextManager
from osprey.approval import create_approval_type

# Third-party imports
from langgraph.types import Command

from osprey.utils.logger import get_logger
logger = get_logger("machine_operations")
...
async def create_operation_plan(current_step: Dict[str, Any], task_objective: str, state: AgentState) -> SimpleOperationPlan:
    ...
    try:
        ...
        machine_operations_config = get_model_config("machine_operations")
...
class MachineOperationsCapability(BaseCapability):
    ...
    async def execute(state: AgentState, **kwargs) -> Dict[str, Any]:
        ...
        streamer = get_streamer("machine_operations", state)
