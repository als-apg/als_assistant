...
from als_assistant.capabilities.live_monitoring import LiveMonitoringCapability
from als_assistant.context_classes import PVAddresses, LauncherResultsContext
...
async def test_live_monitoring_capability_basic_execution(mock_state):
    ...
    with patch('als_assistant.capabilities.live_monitoring.LauncherService') as mock_launcher_class:
        ...
        # Mock configuration
        with patch('als_assistant.capabilities.live_monitoring.get_full_configuration') as mock_config:
...
def test_live_monitoring_error_classification():
    ...
    from als_assistant.capabilities.live_monitoring import (
