...
from als_assistant.context_classes import AnalysisResultsContext
...
async def create_analysis_plan(current_step: Dict[str, Any], task_objective: str, state: AgentState) -> List[AnalysisPhase]:
    ...
    try:
        ...
        data_analysis_config = get_model_config("data_analysis")
...
class DataAnalysisCapability(BaseCapability):
    ...
    async def execute(state: AgentState, **kwargs) -> Dict[str, Any]:
        ...
        streamer = get_streamer("data_analysis", state)
