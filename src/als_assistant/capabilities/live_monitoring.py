...
# Application imports
from als_assistant.services.launcher.service import LauncherService
from als_assistant.services.launcher.models import LauncherServiceRequest
...
logger = get_logger("live_monitoring")
...
class LiveMonitoringCapability(BaseCapability):
    ...
    async def execute(state: AgentState, **kwargs) -> Dict[str, Any]:
        ...
        streamer = get_streamer("live_monitoring", state)
